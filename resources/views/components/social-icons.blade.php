<div {{ $attributes->class(['flex items-center']) }} class="">
    <a
       href="https://facebook.com/omotolani.olurotimi"
       target="_blank"
       class="
       w-10
       h-10
    ...
    <a
       href="https://twitter.com/olurotimitola"
       target="_blank"
       class="
       w-10
       h-10
    ...
    <a
       href="https://www.instagram.com/omotolaniolurotimi"
       target="_blank"
       class="
       w-10
       h-10
    ...
    <a
       href="https://www.linkedin.com/in/omotolani-olurotimi-5b455b12a/"
       target="_blank"
       class="
       w-10
       h-10
