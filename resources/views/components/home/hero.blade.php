        ...
        <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    ...
                    >
                        My name is Omotolani. <br />
                        I am <span class="rounded-md text-amber-600">A Web Developer</span>.
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        I am a developer with over 7 yeras experience in Web Applications Development. <br />
                        ...
                        <a
                            ...
                            href="https://github.com/eldast8sman" target="blank"
                        >
                            GitHub
                        </a>
                    </p>
