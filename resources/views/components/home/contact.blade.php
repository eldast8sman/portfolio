            ...
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
                        If you feel my experience and skills fit your needs, feel free to  contact me.
                    </p>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        <div
                            class="
                                ...
                                text-primarydar:text-gray-300
                                rounded
                            "
                        >
                            
                        <svg class="fill-current" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="50px" height="50px">
                        ...
                        <div class="w-full">
                            ...
                            <a href="tel:+2348105657223" class="text-base text-body dark:text-gray-300">+234 810 565 7223</a>
                        </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        <div
                        ...
                        <div class="w-full">
                            ...
                            <a href="mailto:omotolaniolurotimi@gmail.com" class="text-base text-body dark:text-gray-300">omotolaniolurotimi@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
                    ...
                    <div>
                        ...
                        <x-contact-dot-top></x-contact-dot-top>
                        <x-contact-dot-bottom></x-contact-dot-bottom>
                    </div>
                </div>
            </div>
        </div>
