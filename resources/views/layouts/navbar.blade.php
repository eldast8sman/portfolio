...
<header
    ...
    class="fixed left-0 top-0 z-50 bg-white w-full flex center shadow-md dark:bg-slate-900 h-24"
>
    <div class="container">
        <div class="flex -mx-4 items-center justify-between relative">
            ...
            <div class="flex px-4 justify-end items-center w-full">
                <div>
                    <x-layouts.navbar-hamburger @click="navbarOpen = !navbarOpen"
                                    x-bind:class="navbarOpen && 'navbarTogglerActive'"></x-layouts.navbar-hamburger>
                    <nav
